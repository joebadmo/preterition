...
(defn get-assets []
  (concat
    (assets/load-bundle "public/src" "main.js" ["/js/main.js"])
    (assets/load-assets "public/src" ["/img/joe.xoxomoon.png"])
    (assets/load-bundle "public/src" "style.css" ["/css/style.css"])))
